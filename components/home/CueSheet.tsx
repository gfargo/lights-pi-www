...
const cues: Cue[] = [
  ...
  },
  {
    no: "002",
    act: "I",
    direction: "House lights up. Tungsten key — 3200K.",
    target: 'color_temperature(3200, groups: ["key-lights"])',
    duration: "00 / 02 / 00",
  },
  {
    no: "003",
  ...
  },
  {
    no: "005",
    act: "II",
    direction: "Build a sunset chase from four saved scenes.",
    target: 'create_chase("Sunset", steps: [Daylight, Warm, Amber, Off])',
    duration: "—",
  },
  {
    no: "006",
    act: "II",
    direction: "Cue the chase — slow loop, 5s hold per step.",
    target: 'start_chase("Sunset")',
    duration: "loop",
    accent: true,
  },
  {
  ...
  },
  {
    no: "009",
    act: "II",
    direction: "Stop strobe and chase.",
    target: 'batch_action([strobe("off"), stop_chase("Sunset")])',
    duration: "—",
  },
  {
    no: "010",
