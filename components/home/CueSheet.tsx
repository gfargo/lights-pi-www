...
const cues: Cue[] = [
  ...
  },
  {
    no: "002",
    act: "I",
    direction: "Establish — cool fill from upstage left.",
    target: 'adjust_color("cool", "60%", groups: ["fill-lights"])',
    duration: "00 / 03 / 00",
  },
  {
    no: "003",
  ...
  },
  {
    no: "005",
    act: "II",
    direction: "Strobe accent — RGB across audience.",
    target: 'apply_template("party", groups: ["audience-pars"])',
    duration: "STBY",
  },
  {
    no: "006",
