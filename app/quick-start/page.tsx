      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-16">
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-8">
            <p className="text-gray-600 mb-6">Make sure you have the following before starting:</p>
        ...
        <div className="mt-16 bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-8 border border-purple-100">
          ...
          <ul className="space-y-3 mb-6">
            <li className="flex items-start">
              ...
              <span className="text-gray-700">Explore the QLC+ interface and create more scenes</span>
            </li>
            <li className="flex items-start">
              <span className="text-purple-500 mr-2">→</span>
              <span className="text-gray-700">Set up HTTPS for secure access (optional)</span>
            </li>
            <li className="flex items-start">
              <span className="text-purple-500 mr-2">→</span>
              <span className="text-gray-700">Join our Discord community for support</span>
            </li>
            <li className="flex items-start">
              <span className="text-purple-500 mr-2">→</span>
              <span className="text-gray-700">Share your setup in the showcase gallery</span>
            </li>
          </ul>
          <div className="flex flex-col sm:flex-row gap-4">
            <a
              href="/docs"
              className="inline-flex items-center justify-center bg-purple-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-purple-700 transition"
            >
              View Full Documentation
            </a>
            <a
              href="/community"
              className="inline-flex items-center justify-center bg-white text-purple-600 px-6 py-3 rounded-lg font-semibold hover:bg-purple-50 transition border border-purple-200"
            >
              Join Community
            </a>
          </div>
