      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <div className="max-w-2xl mx-auto">
            <input
              ...
              className="w-full px-6 py-4 rounded-xl border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none transition"
            />
          </div>
        </div>
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-4 gap-4">
            <Link href="/quick-start" className="bg-blue-50 border border-blue-200 rounded-xl p-4 hover:shadow-md transition text-center">
              <div className="font-semibold text-blue-900">Quick Start</div>
              <div className="text-sm text-blue-600">Get started in 10 min</div>
            </Link>
            <Link href="/hardware" className="bg-purple-50 border border-purple-200 rounded-xl p-4 hover:shadow-md transition text-center">
              <div className="font-semibold text-purple-900">Hardware Guide</div>
              <div className="text-sm text-purple-600">Shopping list & setup</div>
            </Link>
            <Link href="#" className="bg-pink-50 border border-pink-200 rounded-xl p-4 hover:shadow-md transition text-center">
              <div className="font-semibold text-pink-900">Troubleshooting</div>
              <div className="text-sm text-pink-600">Common issues</div>
            </Link>
            <Link href="#" className="bg-green-50 border border-green-200 rounded-xl p-4 hover:shadow-md transition text-center">
              ...
              <div key={index} className="bg-white rounded-2xl border border-gray-200 p-8 hover:shadow-lg transition">
                ...
                <ul className="space-y-2">
                  {category.links.map((link, i) => (
                    <li key={i}>
                      <Link href={link.href} className="text-blue-600 hover:text-blue-700 hover:underline">
                        {link.name}
                      </Link>
                    </li>
                  ))}
        ...
        <div className="mt-16 bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/community" className="inline-block bg-white text-purple-600 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition">
              Join Discord
            </Link>
